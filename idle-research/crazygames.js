    ...
    `),
				...
				const vn = class {
						...
						async requestVideoAdUrl(e, t) {
							...
							if (z()) {
								const e = () => "https://blocked.invalid/gampad/ads?sz=640x480&iu=/124319096/external/single_ad_samples&ciu_szs=300x250&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&cust_params=deployment%3Ddevsite%26sample_ct%3Dskippablelinear&overlay=1&correlator=",
									t = {};
								return (
									n.forEach((n) => {
						...
						if (!s)
							try {
								(window.dataLayer = [] || 0),
									...
									(0, T.ve)("https://blocked.invalid/gtag/js?id=AW-awdasdawd"),
